    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl">
        ...
        <p className="mb-6 text-center text-sm text-gray-500">
          {loading ? "processing" : " Sign up to get started"}
        </p>
        ...
        <button
          onClick={Signup}
          className="mt-6 w-full rounded-lg bg-indigo-600 py-2.5 text-sm font-semibold text-white transition hover:bg-indigo-700 active:scale-95 cursor-pointer"
        >
